...
const Cart = () => {
  return (
    <div className="min-h-[calc(100vh_-_433px)]" >
      ...
      <div className="min-h-[calc(100vh_-_433px)] flex items-center flex-1 p-10 overflow-w-scroll">
        <table className="w-full txt-sm text-center text-gray-500 min-h-[1000px]">
      ...
      <div className="bg-secondary min-h-[calc(100vh_-_433px)] flex flex-col justify-center text-white p-12 md:w-auto w-full">
        ...
        <button className="bg-primary mt-4">Checkout Now</button>
      </div>
      </div>
    </div>
  );
