    ...
    <div className="mt-5 mx-4">
      <div className="p-6 bg-secondary text-white rounded-[5px]">
        <p>
          ...
          porro repellat animi id necessitatibus blanditiis quam similique
          libero in odit, minima veritatis at maxime cupiditate cum doloribus
          aperiam labore itaque.
        </p>
